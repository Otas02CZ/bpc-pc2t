...
public class RunApp {
  ...
  public static void main(String[] args) {
    ...
    while (run) {
      ...
      System.out.println("3 .. vypis emailu, jmena a prijmen o vsech uzivatelech");
      System.out.println("4 .. vyis vsech uzivatelu s role USER");
      ...
      System.out.println("7 .. vypis vsech rolí v systému");
